            ...
            <div class="floor-tab" node-type="navTit">
                <ul class='yiminUl'>
                    ...
                    <div style='height:265px;'> 
                        <li :class="{'cur':!index}" v-for='(item,index) in yiContry' v-if='index<5' @mouseover='yiminHover(index,$event)' @mouseout='yiminOut(index,$event)' @click='detClick("yimin","",item.countryName)'  style='cursor: pointer;clear:both;' ><img class='countryImg' :src='item.httpPath'/><span>{{item.countryName}}</span> <b></b></li>
                    </div>
                    
                     <li class="clearfix yiMinContryMore" @click="detClick('yimin')"><img src='./img/yiMinContryMore.png' class='countryImg'/><span>更多</span></li>
                    <!-- <li class="clearfix" sup-namenav="yd"><img src='./img/usa.png' class='countryImg'/><span>澳大利亚</span> <b></b></li>
                    <li class="clearfix" sup-namenav="dcrz"><img src='./img/usa.png' class='countryImg'/><span>法国</span> <b></b></li>
                    <li class="clearfix" sup-namenav="jdky"><img src='./img/usa.png' class='countryImg'/><span>土耳其</span> <b></b></li>
                    <li class="clearfix" sup-namenav="qyjc"><img src='./img/usa.png' class='countryImg'/><span>日本</span> <b></b></li>
                    <li class="clearfix" sup-namenav="jbb"><img src='./img/usa.png' class='countryImg'/><span>中国</span> <b></b></li>  -->
                    <!-- </el-scrollbar> -->
                </ul>
            </div>
            <ul class="floor-cont" node-type="navCont" id='yiXm' style='background: #414044;width: 996px;height: 340px;left:0px;top:175px;'>
                <li class="floor-item cur" v-if='index==0':sup-nameadd="index" v-for='(item,index) in yiminList'>
                    <div class='proBox'>
                        <div class="product-info"  v-for='z in item.itemEntity' style="background:#eaeaea;">
                            <img :src="z.httpPath" width="572" height="310" alt="" style='opacity:0.5;cursor:pointer;' @click='detClick("yimindet",z.itemId)'>
                            <div class="product-tit">
                                <span>{{z.certType}}</span>
                                <h3>{{yiTitle(z.itemTitle)}}</h3>
                                <p>{{yispot(z.lightspot)}}</p>
                        ...
                        <ul class="characteristic fr">
                            <li class='charLiTop'>                                
                                <span class='fl charLitit'>移民指南</span><span class='fr charLimore' style='cursor: pointer;' @click='detClick("news")'>更多&nbsp;></span>
                            </li><!--charLiTop-->
                 ...
                 <li class="floor-item" v-if='index!=0' :sup-nameadd="index" v-for='(item,index) in yiminList'>
                    <div class='proBox'>
                        <div class="product-info"  v-for='z in item.itemEntity' style="background:#eaeaea">
                            <img :src="z.httpPath" width="572" height="310" alt="" style='opacity:0.5;'>
                            <div class="product-tit">
                                <span>{{z.certType}}</span>
                               <h3>{{yiTitle(z.itemTitle)}}</h3>
                                <p>{{yispot(z.lightspot)}}</p>
                        ...
                        <ul>
                            <li v-for='(item,index) in haiwaiList' :itemId='item.itemId' @click='detClick("haiWdet",item.itemId)' v-if='index<3'>
                                <div class='hwpad'>
                                    ...
                                    <div class='hwText'>
                                        <p class="hwTit">{{item.itemTitle}}</p>
                                        <p class='hwBto'>
            ...
            <div class="floor clearfix" node-type="navTab">
               ...
               <div class='liuxueBox'>
                   <div class='liuxueOne' v-for='item in liuxueList' @click='detClick("liuxuedet",item.itemId)'>
                       ...
                       <div class='liuMengB'>
                           <div class='liuMeng'>
                            <p class='liuTit'><span>{{item.itemTitle}}</span></p>
                            <p class='liuIntr'>{{item.lightspot}}</p>
